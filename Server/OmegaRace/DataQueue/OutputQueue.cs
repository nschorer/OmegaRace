        ...
        public static void Process()
        {
            while (instance.pOutputQueue.Count > 0)
            {
                ...
                if (DataMessage.GetMode() != DataMessage.Mode.PLAYBACK)
                {
                    ...
                    bool sendLocally = ((int)msg.target & (int)DataMessage.DeliveryTarget.ServerOnly) > 0;
                    bool sendToClient = ((int)msg.target & (int)DataMessage.DeliveryTarget.ClientOnly) > 0;
